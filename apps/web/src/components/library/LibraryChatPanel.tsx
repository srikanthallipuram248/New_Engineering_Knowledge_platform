...
import { askChat, createChatSession } from '@/services/api'
import type {
  ChatApiResponse,
  ChatHistoryMessage,
  ChatSource,
...
export function LibraryChatPanel({
  ...
  async function startNewChat(
    ...
    if (existingEmpty) {
      ...
      if (!existingEmpty.backendSessionId) {
        ...
        existingEmpty.backendSessionId =
          backendSession.id
      }
  ...
  async function sendMessage(text: string) {
    ...
    try {
      ...
      console.log("BACKEND SESSION ID", currentSession.backendSessionId)
